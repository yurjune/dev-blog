...
<video autoplay loop muted playsinline controls width="800">
  <source src="sidekick-cli.mp4" type="video/mp4" />
</video>
...
아래 영상을 보시면 Tab 키를 통해 다음 코드 제안 위치로 이동하고 suggestion을 accept 할 수 있으며, 변경할 코드의 diff가 표시되는 것을 확인할 수 있습니다.

<video autoplay muted playsinline controls width="800">
  <source src="sidekick-nes.mp4" type="video/mp4" />
</video>
